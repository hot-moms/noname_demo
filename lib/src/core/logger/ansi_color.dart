...
class AnsiColor {
  ...
  static String _emit(String ansicode) => '$esc${ansicode}m';
  ...
  static String _apply(
    ...
    if (stdout.supportsAnsiEscapes || Platform.isWindows) {
  ...
  static String get _reset => '$esc${_resetCode}m';
  ...
  static String _fg(
    ...
    if (code == none.code) {
      ...
      output = '$esc$_fgColorCode$code${bold ? ';1' : ''}m';
    } else {
      output = '$esc$code${bold ? ';1' : ''}m';
    }
    return output;
  }
  ...
  static String _bg(int code) {
    ...
    if (code == none.code) {
      ...
      output = '$esc$_backgroundCode${code + 10}m';
    } else {
